...
### 📖 Introduction
**AST Deobfuscator** is a powerful Python reverse-engineering tool designed to analyze and clean obfuscated code using Abstract Syntax Trees (AST), yet it packs robust features to handle complex protection schemes like **String Encryption**, and **Junk Code Injection**.
...
val = 550
<div align="right">
<a href="#-katakana-ast-deobfuscator">⬆️ Back to Top</a>
</div>
...
AST Deobfuscator là một công cụ dịch ngược mã nguồn Python mạnh mẽ dựa trên AST (Cây cú pháp trừu tượng), chuyên trị các loại mã hóa phức tạp như Mã hóa chuỗi, và Chèn code rác.
